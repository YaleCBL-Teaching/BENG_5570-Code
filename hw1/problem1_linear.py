...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 20 16:55:17 2025
...
def p_load(xi):
    # This is the distributed load defined on the Global coordinate system
    p = (1/2)*q*xi + q
    return p


# Since the distributed loaded is linear, at least a 2-point Gaussian quadrature is needed for
# exact integration.
